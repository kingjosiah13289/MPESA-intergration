"""morningdjangoproject2 URL Configuration
...
urlpatterns = [
    ...
    path('addproduct/', general_views.add_product, name='add products'),
    path('products', general_views.views_products, name='products'),
    path('delete-product/<id>', general_views.delete_product, name='delete'),
